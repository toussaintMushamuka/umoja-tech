        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-8 items-center">
          ...
          >
            <div className="space-y-6">
              ...
              >
                Umoja Tech est là pour vous avec une gamme complète de services de
            ...
            <motion.div variants={itemVariants} className="flex flex-col gap-4 sm:flex-row">
              <Link href="/services" className="w-full sm:w-auto">
                <Button size="lg" className="w-full rounded-full px-8 h-12 text-base">
                  Découvrir nos services
                </Button>
              </Link>
              <Link href="/contact" className="w-full sm:w-auto">
                <Button variant="outline" size="lg" className="w-full rounded-full px-8 h-12 text-base">
                  Demander un devis
                </Button>
              </Link>
            </motion.div>
            ...
            {/* Stats Section */}
            <motion.div variants={itemVariants} className="flex flex-wrap items-center gap-6 sm:gap-8 pt-4">
